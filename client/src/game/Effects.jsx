...
export default function Effects() {
  return (
    ...
    <EffectComposer multisampling={0} frameBufferType={HalfFloatType}>
      ...
      {!FLAGS.noao && <N8AO aoRadius={0.9} intensity={3.2} distanceFalloff={1.2} quality="performance" halfRes />}
      ...
      {!FLAGS.nobloom && <Bloom intensity={0.6} luminanceThreshold={1.05} luminanceSmoothing={0.3} mipmapBlur />}
      <SpeedFX />
      <Vignette eskil={false} offset={0.22} darkness={0.72} />
      {!FLAGS.nosmaa && <SMAA />}
      <ToneMapping mode={FLAGS.agx ? ToneMappingMode.AGX : ToneMappingMode.ACES_FILMIC} />
    </EffectComposer>
  );
}
